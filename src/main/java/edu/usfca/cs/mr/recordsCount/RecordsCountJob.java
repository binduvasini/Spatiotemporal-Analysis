 ...
 */
public class RecordsCountJob {
    public static void main(String[] args) {
        try {
            Configuration conf = new Configuration();
            // Give the MapRed job a name. You'll see this name in the Yarn
            // webapp.
            Job job = Job.getInstance(conf, "records count job");
            // Current class.
            job.setJarByClass(RecordsCountJob.class);
            // Mapper
            job.setMapperClass(RecordsCountMapper.class);
            // Combiner. We use the reducer as the combiner in this case.
            job.setCombinerClass(RecordsCountReducer.class);
            // Reducer
            job.setReducerClass(RecordsCountReducer.class);
