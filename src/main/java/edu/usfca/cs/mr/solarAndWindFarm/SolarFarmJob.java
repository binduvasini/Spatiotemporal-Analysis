 ...
 */
public class SolarFarmJob {
    public static void main(String[] args) {
        try {
            Configuration conf = new Configuration();
            // Give the MapRed job a name. You'll see this name in the Yarn
            // webapp.
            Job job = Job.getInstance(conf, "solar farm job");
            // Current class.
            job.setJarByClass(SolarFarmJob.class);
            // Mapper
            job.setMapperClass(SolarFarmMapper.class);
            // Combiner. We use the reducer as the combiner in this case.
            job.setCombinerClass(SolarFarmReducer.class);
            // Reducer
            job.setReducerClass(SolarFarmReducer.class);
